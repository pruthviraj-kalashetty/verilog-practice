...
module sequence_detector_1011_non_overlap_tb;

reg clk;
reg x;
wire y;

sequence_detector_1011_non_overlap DUT(
    .clk(clk),
    .x(x),
    .y(y)
);
...
initial begin
    $dumpfile("sequence_detector_1011_non_overlap.vcd");
    $dumpvars(0, sequence_detector_1011_non_overlap_tb);
end
...
![Sequence-Detector-1011-non-overlapping RTL Schematic](rtl-schematic.png)

# 📈 **Simulation Result**
![Sequence-Detector-1011-non-overlapping waveform](waveform.png)
