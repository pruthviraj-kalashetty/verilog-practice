...
| :--- | :--- |
| **[01-SR-Latch](./01-Latches/01-SR-Latch/)** | Design and verification of an SR latch using synthesizable Verilog RTL, including set, reset, hold, and invalid conditions. |
